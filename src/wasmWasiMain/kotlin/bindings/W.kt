...
object Jsiface {
  class X internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_X_drop(__handle.value)
    }
...
object Error {
  ...
  class Error internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_Error_drop(__handle.value)
    }
    /**
...
object Poll {
  ...
  class Pollable internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_Pollable_drop(__handle.value)
    }
    /**
...
object Streams {
  ...
  class InputStream internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_InputStream_drop(__handle.value)
    }
    /**
                  ...
                  when ((ptr + 4).ptr.loadUByte().toInt()) {
                    0 -> {
                      Streams.StreamError.LastOperationFailed(
                          Error.Error(ResourceHandle((ptr + 8).ptr.loadInt())))
                    }
                    1 -> {
            ...
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              ...
              val variant =
                  when ((ptr + 8).ptr.loadUByte().toInt()) {
                    0 -> {
                      Streams.StreamError.LastOperationFailed(
                          Error.Error(ResourceHandle((ptr + 12).ptr.loadInt())))
                    }
                    1 -> {
                      Streams.StreamError.Closed
                    }
  ...
  class OutputStream internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_OutputStream_drop(__handle.value)
    }
    /**
...
object TerminalInput {
  ...
  class TerminalInput internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_TerminalInput_drop(__handle.value)
    }
...
object TerminalOutput {
  ...
  class TerminalOutput internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_TerminalOutput_drop(__handle.value)
    }
...
object Types {
  ...
  class Descriptor internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_Descriptor_drop(__handle.value)
    }
    /**
        ...
        val result =
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              Result<Streams.InputStream>
                  .success(Streams.InputStream(ResourceHandle((ptr + 4).ptr.loadInt())))
            } else {
              Result<Streams.InputStream>
                  .failure(
                      ComponentException(
        ...
        val result =
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              Result<Streams.OutputStream>
                  .success(Streams.OutputStream(ResourceHandle((ptr + 4).ptr.loadInt())))
            } else {
              Result<Streams.OutputStream>
                  .failure(
                      ComponentException(
    ...
    public fun advise(offset: ULong, length: ULong, advice: Types.Advice): Result<Unit> {
      ...
      withScopedMemoryAllocator { allocator ->
        ...
        __wasm_import_advise(
            this.__handle.value, offset.toLong(), length.toLong(), advice.ordinal, ptr)
        freeAllComponentModelReallocAllocatedMemory()
        val result =
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              Result<Unit>.success(Unit)
    ...
    public fun setTimes(
      ...
      withScopedMemoryAllocator { allocator ->
        ...
        __wasm_import_setTimes(
            this.__handle.value, variant, variant2, variant3, variant7, variant8, variant9, ptr)
        freeAllComponentModelReallocAllocatedMemory()
        val result =
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              Result<Unit>.success(Unit)
        ...
        val result =
            if ((ptr + 0).ptr.loadUByte().toInt() == 0) {
              Result<Types.DirectoryEntryStream>
                  .success(Types.DirectoryEntryStream(ResourceHandle((ptr + 4).ptr.loadInt())))
            } else {
              Result<Types.DirectoryEntryStream>
                  .failure(
                      ComponentException(
    ...
    public fun linkAt(
      ...
      withScopedMemoryAllocator { allocator ->
        ...
        __wasm_import_linkAt(
            this.__handle.value,
            oldPathFlags._value.toInt(),
            ptr,
            len,
            newDescriptor.__handle.value,
            ptr0,
            len1,
            ptr3)
        freeAllComponentModelReallocAllocatedMemory()
    ...
    public fun openAt(
      ...
      withScopedMemoryAllocator { allocator ->
        ...
        val result =
            if ((ptr0 + 0).ptr.loadUByte().toInt() == 0) {
              Result<Types.Descriptor>
                  .success(Types.Descriptor(ResourceHandle((ptr0 + 4).ptr.loadInt())))
            } else {
              Result<Types.Descriptor>
                  .failure(
                      ComponentException(
    ...
    public fun renameAt(
      ...
      withScopedMemoryAllocator { allocator ->
        ...
        val ptr3 = /* RETURN_ADDRESS_ALLOC(size=2, align=1)*/ allocator.allocate(2).address.toInt()
        __wasm_import_renameAt(
            this.__handle.value, ptr, len, newDescriptor.__handle.value, ptr0, len1, ptr3)
        freeAllComponentModelReallocAllocatedMemory()
        val result =
            if ((ptr3 + 0).ptr.loadUByte().toInt() == 0) {
              Result<Unit>.success(Unit)
  ...
  class DirectoryEntryStream internal constructor(internal val __handle: ResourceHandle) :
      AutoCloseable {
    override fun close() {
      __wasm_import_DirectoryEntryStream_drop(__handle.value)
    }
...
object Network {
  ...
  class Network internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_Network_drop(__handle.value)
    }
...
object Udp {
  ...
  class UdpSocket internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_UdpSocket_drop(__handle.value)
    }
    /**
  ...
  class IncomingDatagramStream internal constructor(internal val __handle: ResourceHandle) :
      AutoCloseable {
    override fun close() {
      __wasm_import_IncomingDatagramStream_drop(__handle.value)
    }
    /**
  ...
  class OutgoingDatagramStream internal constructor(internal val __handle: ResourceHandle) :
      AutoCloseable {
    override fun close() {
      __wasm_import_OutgoingDatagramStream_drop(__handle.value)
    }
    /**
...
object Tcp {
  ...
  class TcpSocket internal constructor(internal val __handle: ResourceHandle) : AutoCloseable {
    override fun close() {
      __wasm_import_TcpSocket_drop(__handle.value)
    }
    /**
     * Bind the socket to a specific network on the provided IP address and port.
     *
...
object IpNameLookup {
  class ResolveAddressStream internal constructor(internal val __handle: ResourceHandle) :
      AutoCloseable {
    override fun close() {
      __wasm_import_ResolveAddressStream_drop(__handle.value)
    }
    /**
